...
class SCMEntry(models.Model):
    ...
    package_ids = fields.Many2many('ihh.package', string='Package', domain="[('channel_id', '=', channel_ids)]")
    item_line_ids = fields.Many2many('ihh.item.line', string='Item', domain="[('package_id', '=', package_ids)]")
