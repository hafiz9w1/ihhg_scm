...
class SCMEntry(models.Model):
    ...
    user__project_id = fields.Many2one('res.users', string='Project Manager', tracking=True)
    channel = fields.Many2one('ihh.channel', string='Channel')
    originating_regulation = fields.Many2one('store.regulation.entry', string='Originating Regulation')
