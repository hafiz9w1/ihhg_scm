...
class SCMEntry(models.Model):
    ...
    channel_ids = fields.Many2many('ihh.channel', string='Channel')
    package_ids = fields.Many2many('ihh.package', string='Package', domain="[('channel_id', 'in', channel_ids)]")
    item_line_ids = fields.Many2many('ihh.item.line', string='Item', domain="[('package_id', 'in', package_ids)]")
